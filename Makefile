...
## 
CFLAGS = -DBOOST_RESULT_OF_USE_TR1 -DBOOST_NO_DECLTYPE -DBOOST_DISABLE_ASSERTS -I $(STAN_SRC) -I $(STAN)src -I $(MATH) -I $(EIGEN) -I $(BOOST) -I $(CVODES) -Wall -pipe -DEIGEN_NO_DEBUG
